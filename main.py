...
DATA_DIR = f"{PROJECT_DIR}/datasets/hunmin_ko"
...
if __name__ == "__main__":
    ...
    # args.model_name = "monologg/kobert-lm"
    now = "kykim_bert_0929_11"
    ...
    # python main.py -mode train -target_summary_sent abs -visible_gpus 0 -train_from 1209_1236/model_step_7000.pt
        ...
        # -label_smoothing", default=0.1, "-beam_size", default=5 -dec_dropout", default=0.2, "-ext_dropout", default=0.2,
        ...
        param4 = (
            ...
            + "  -train_steps 3000 -save_checkpoint_steps 100  -report_every 10"
            + " -use_interval true"
            # + " -train_from model_step_500.pt"
        )
        # param5 = (
        #     " -ext_dropout 0.15 -label_smoothing 0.10 -max_pos 512 -batch_size 7000 -accum_count 2"
        #     + " -lr 2e-3 -warmup_steps 2000 "  # 전체가 21632개인데  평균 9.6문장이니 207667문장/ 5000 = 41.5
        #     + "  -train_steps 3000 -save_checkpoint_steps 100  -report_every 10"
        #     + " -use_interval true"
        # )
        do_str += param4
        ...
        if args.train_from is None:
            ...
            do_str += f" -model_path {MODEL_DIR}/{now}" + f" -log_file {LOG_DIR}/train_{now}.log"
        else:
    ...
    # python main.py -mode valid -model_path 1209_1236
        ...
        """
        os.system(
            f"python train.py -task {args.task} -mode validate -test_all True"
            + f" -model_name {args.model_name}"
    ...
    # python main.py -mode test -test_from 1209_1236/model_step_7000.pt -visible_gpus 0
        ...
        os.system(
            f"""\
            python train.py -task {args.task} -mode test \
