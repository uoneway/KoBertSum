...
if __name__ == "__main__":
    ...
    parser.add_argument("-tgt_type", default="str_list", choices=["idx_list", "str_list", "str"], type=str)
    ...
    parser.add_argument("-min_src_nsents", default=3, type=int)  # 3 -> 1
    parser.add_argument("-max_src_nsents", default=120, type=int)  # 100
    parser.add_argument("-min_src_ntokens_per_sent", default=5, type=int)  # 5
    parser.add_argument("-max_src_ntokens_per_sent", default=300, type=int)  # 200
    parser.add_argument("-min_tgt_ntokens", default=5, type=int)  # 5
    parser.add_argument("-max_tgt_ntokens", default=600, type=int)  # 500
